  ...
  return (
    <div className="min-h-[40vh] flex justify-center items-center flex-col gap-3 mx-6">
      ...
      <input
        ...
        className="outline-none min-w-[300px] max-w-[700px] w-full dm-bg-rev p-4 rounded-full placeholder:text-center placeholder:text-lg focus:ring-3 ring-gray2 md:mt-4"
        value={searchResult}
